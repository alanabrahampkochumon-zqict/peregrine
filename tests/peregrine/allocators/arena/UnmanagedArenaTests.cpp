/**
 * @file UnmanagedArenaTests.cpp
 * @author Alan Abraham P Kochumon
 * @date Created on: August 08, 2026
 *
 * @brief Verify unmanaged arena allocation, free, and helper function logic.
 *
...
namespace
{
     ...
     */
    class UnmanagedArenaTests: public testing::Test
    {
    public:
...
TEST_F(UnmanagedArenaTests, ArenaHasZeroUsedSizeInitially) { EXPECT_EQ(0, arena.usedSize()); }


TEST_F(UnmanagedArenaTests, ArenaHasFreeSpaceEqualToSizeInitially) { EXPECT_EQ(arenaSize, arena.freeSize()); }
...
TEST_F(UnmanagedArenaTests, MoveCtor_MovesTelemetry)
{
...
TEST_F(UnmanagedArenaTests, MoveAssign_MovesTelemetry)
{
    const auto buffer2 = new uint8_t[256];
    static_cast<void>(arena.allocBytes(120));
    static_cast<void>(arena.allocBytes(240));
 ...
 */
TEST_F(UnmanagedArenaTests, AllocBytes_Returns8ByteAlignedAddressByDefault)
{
    // Misalign bytes to 2
...
TEST_F(UnmanagedArenaTests, AllocBytes_ReturnsProvidedByteAlignedAddress)
{
...
TEST_F(UnmanagedArenaTests, AllocBytes_ReturnsNonNullPtrWhenAllocatingMemoryLessThanArenaSize)
{
...
TEST_F(UnmanagedArenaTests, AllocBytes_ReturnsNonNullPtrWhenAllocatingMemoryEqualArenaSize)
{
...
TEST_F(UnmanagedArenaTests, AllocBytes_SubsequentAllocationDoNotCorruptMemory)
{
...
TEST_F(UnmanagedArenaTests, AllocBytes_UpdatesTelemetry)
{
...
TEST_F(UnmanagedArenaTests, Alloc_AllocatesAnObjectInTheArena)
{
...
TEST_F(UnmanagedArenaTests, Alloc_AlignsToTargetAlignment)
{
    // Allocate a 2 byte alignment forcing a misalignment to 2 bytes
...
TEST_F(UnmanagedArenaTests, Alloc_UpdatesTelemetry)
{
    // Allocate a 2 byte alignment forcing a misalignment to 2 bytes
...
TEST_F(UnmanagedArenaTests, AllocV_ReturnsAContinguousBlockOfMemory)
{
...
TEST_F(UnmanagedArenaTests, AllocV_SubsequentAllocationDoNotCorruptMemory)
{
...
TEST_F(UnmanagedArenaTests, AllocV_UpdatesTelemetry)
{
...
TEST_F(UnmanagedArenaTests, Resize_NewSizeSmallerThanOldSizeReturnsSameAddress)
{
...
TEST_F(UnmanagedArenaTests, Resize_LatestAllocationOnlyResizeByOffsetDifference)
{
    constexpr auto byteSize    = 128;
...
TEST_F(UnmanagedArenaTests, Resize_AllocationPriorToLatestAllocationReturnNewBuffer)
{
    constexpr auto byteSize    = 128;
    constexpr auto newByteSize = byteSize * 2;
...
TEST_F(UnmanagedArenaTests, Resize_AllocationPriorToLatestAllocationCopiesOldData)
{
    ;
    constexpr auto byteSize    = 128;
    constexpr auto newByteSize = byteSize * 2;
...
TEST_F(UnmanagedArenaTests, Resize_SameMemorySize_DoesNotUpdateTelemetry)
{
    constexpr auto byteSize = 128;
...
TEST_F(UnmanagedArenaTests, Resize_SmallerMemorySize_DoesNotUpdateTelemetry)
{
    constexpr auto byteSize    = 128;
...
TEST_F(UnmanagedArenaTests, Resize_LatestAllocationResize_UpdatesTelemetry)
{
    constexpr auto byteSize       = 128;
...
TEST_F(UnmanagedArenaTests, Resize_InBetweenAllocationResize_UpdatesTelemetry)
{
    constexpr auto byteSize       = 128;
    constexpr auto byteDifference = 100;
    constexpr auto newByteSize    = byteSize + byteDifference;
...
TEST_F(UnmanagedArenaTests, ResizeFast_NewSizeSmallerThanOldSizeReturnsNewBufferWithOldData)
{
    constexpr auto byteSize   = 128;
...
TEST_F(UnmanagedArenaTests, ResizeFast_LatestAllocationReturnsNewBufferWithOldData)
{
    constexpr auto byteSize    = 128;
    constexpr auto newByteSize = byteSize * 2;
...
TEST_F(UnmanagedArenaTests, ResizeFast_AllocationPriorToLatestAllocationReturnNewBufferWithOldData)
{
    constexpr auto byteSize    = 128;
    constexpr auto newByteSize = byteSize * 2;
...
TEST_F(UnmanagedArenaTests, ResizeFast_SameMemorySize_UpdatesTelemetry)
{
    constexpr auto byteSize = 128;
...
TEST_F(UnmanagedArenaTests, Resize_SmallerMemorySize_UpdatesTelemetry)
{
    constexpr auto byteSize    = 128;
    constexpr auto newByteSize = byteSize - 10;
...
TEST_F(UnmanagedArenaTests, ResizeFast_LatestAllocationResize_UpdatesTelemetry)
{
    constexpr auto byteSize       = 128;
    constexpr auto byteDifference = 100;
    constexpr auto newByteSize    = byteSize + byteDifference;
...
TEST_F(UnmanagedArenaTests, ResizeFast_InBetweenAllocationResize_UpdatesTelemetry)
{
    constexpr auto byteSize       = 128;
    constexpr auto byteDifference = 100;
    constexpr auto newByteSize    = byteSize + byteDifference;
...
namespace pmm
{
    ...
    TEST_F(UnmanagedArenaTests, MoveCtor_MovesBufferIntoNewObject)
    {
    ...
    TEST_F(UnmanagedArenaTests, MoveAssign_SelfAssignmentReturnsTheSameArena)
    {
     ...
     */
    TEST_F(UnmanagedArenaTests, AllocBytes_MovesPrevOffset)
    {
        // Allocate a 2 byte alignment forcing a misalignment to 2 bytes
        static_cast<void>(arena.allocBytes(2, 2));
        ...
        [[maybe_unused]] const auto memory = arena.allocBytes(bufferSize, alignment);
     ...
     *       moved by relative to the allocated object's size.
     */
    TEST_F(UnmanagedArenaTests, Alloc_MovesPrevOffset)
    {
        // Allocate a 2 byte alignment forcing a misalignment to 2 bytes
        static_cast<void>(arena.allocBytes(2, 2));
    ...
    TEST_F(UnmanagedArenaTests, Clear_OnlyResetsCurrentTelemetryUsage)
    {
        constexpr std::size_t byte1 = 20, byte2 = 56, byte3 = 128;
    ...
    TEST_F(UnmanagedArenaTests, Resize_LatestAllocationResizeBuffer)
    {
        constexpr auto byteSize    = 128;
        constexpr auto newByteSize = byteSize * 2;
