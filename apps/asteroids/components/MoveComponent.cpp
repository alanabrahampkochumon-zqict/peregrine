...
{
    MoveComponent::MoveComponent(actors::Actor* owner, const int updateOrder): Component{ owner, updateOrder }
    ...
    MoveComponent::~MoveComponent() noexcept { _owner->removeComponent(this); }
